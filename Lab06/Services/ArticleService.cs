...
public class ArticleService : IArticleService
{
    ...
    public async Task<List<Article>> GetAllAsync(int? categoryId = null, CancellationToken cancellationToken = default)
    {
        if (categoryId.HasValue)
            return await _unitOfWork.ArticleRepository.GetByCategoryAsync(categoryId.Value, cancellationToken);
    ...
    {
        return await _unitOfWork.ArticleRepository.CountAsync(categoryId, cancellationToken);
    }
    ...
    {
        return await _unitOfWork.ArticleRepository.GetPagedAsync(page, pageSize, categoryId, cancellationToken);
    }
